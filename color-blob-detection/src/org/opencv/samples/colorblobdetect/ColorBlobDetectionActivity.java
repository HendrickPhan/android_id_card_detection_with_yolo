...
public class ColorBlobDetectionActivity extends CameraActivity implements CvCameraViewListener2 {
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        String weights = getPath("custom-yolov4-tiny-detector_final.weights", this);
        String cfg = getPath("custom-yolov4-tiny-detector.cfg", this);
